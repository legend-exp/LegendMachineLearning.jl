...
l200, processing_config, group_name = get_processingconfig()
@info "Start ML data processing for group: $group_name"; flush(stderr)

# Load processors (only include files whose processor is enabled — avoids heavy
# ML/CUDA precompilation when running CPU-only flow steps)
...
# Execute enabled processors in order
flush(stdout)

for process in processing_config.enabled_steps
    @info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    @info "Processor: $(string(process))"
    ...
    try
        ...
        @error "Processor failed" process exception=(e, catch_backtrace())
    end
end
